...
class CountryCoupons extends StatefulWidget {
  final Country country;

  CountryCoupons({this.country});

  @override
  _CountryCouponsState createState() => _CountryCouponsState();
}

class _CountryCouponsState extends State<CountryCoupons> {
